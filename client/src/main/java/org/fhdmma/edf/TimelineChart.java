...
public class TimelineChart extends XYChart<Number, String> {
    ...
    private double getLength() {
        ...
        return axis.getScale() * 0.95;
    }

    private double getShift() {
        NumberAxis axis = (NumberAxis) this.getXAxis();
        return axis.getScale() * 0.05;
    }
    ...
    private Node createContainer(Series<Number, String> series, int seriesIndex, final Data<Number, String> item,
            int itemIndex) {
